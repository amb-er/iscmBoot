...
@XmlRootElement(name = "scmIndustryGroup")  
public class ScmIndustryGroup extends BaseModel {
	...
	public ScmIndustryGroup(boolean defaultValue) {
		if (defaultValue) {
			this.flag=true;
		}
	}
  	public ScmIndustryGroup() {
	}
