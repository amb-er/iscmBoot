...
@XmlRootElement(name = "scmMeasureUnitGrouplAssign")  
public class ScmMeasureUnitGrouplAssign extends BaseModel  {
    ...
    public ScmMeasureUnitGrouplAssign(boolean defaultValue){
       if(defaultValue){
       }
    }
  	public ScmMeasureUnitGrouplAssign() {
