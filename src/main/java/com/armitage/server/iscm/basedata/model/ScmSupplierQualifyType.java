...
@XmlRootElement(name = "scmSupplierQualifyType")  
public class ScmSupplierQualifyType extends BaseModel {
	...
	public ScmSupplierQualifyType(boolean defaultValue) {
		if (defaultValue) {
			this.flag=true;
			this.sort=1;
		}
	}
  	public ScmSupplierQualifyType() {
	}
