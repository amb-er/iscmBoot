...
@XmlRootElement(name = "scmMaterialGroupStandard")  
public class ScmMaterialGroupStandard extends BaseModel  {
    ...
    public ScmMaterialGroupStandard(boolean defaultValue){
       if(defaultValue){
    	   this.standardType="2";
       }
    }
  	public ScmMaterialGroupStandard() {
    ...
    public List<String[]> getUniqueKeys() {
		...
		list.add(new String[] { FN_STANDARDNO, FN_CONTROLUNITNO });
		return list;
	}
	 
	public String[] getRequiredFields() {
		return new String[] {FN_STANDARDNO,FN_STANDARDNAME };
	}
