...
@XmlRootElement(name = "scmMaterialGroupAssign")  
public class ScmMaterialGroupAssign extends BaseModel  {
    ...
    public ScmMaterialGroupAssign(boolean defaultValue){
       if(defaultValue){
       }
    }
  	public ScmMaterialGroupAssign() {
