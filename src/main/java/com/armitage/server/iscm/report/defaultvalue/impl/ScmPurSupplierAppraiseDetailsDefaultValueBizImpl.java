...
public class ScmPurSupplierAppraiseDetailsDefaultValueBizImpl extends DefaultValueBizImpl{
	...
	public String getDefaultValue(String usrCode, String orgUnitNo, String controlUnitNo) {
		...
		defaultValue.append("begDate=").append(firstDay).append(",").append("endDate=").append(lastDay)
