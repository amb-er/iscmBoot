 ...
 * 物资入库明细
 */
@XmlRootElement(name = "ScmInvItemWrDetails")  
public class ScmInvItemWrDetails  extends BaseModel {
	...
	private BigDecimal addInTaxAmount; //税额
    ...
    public BigDecimal getAddInTaxAmount() {
        return addInTaxAmount;
    }

    public void setAddInTaxAmount(BigDecimal addInTaxAmount) {
        this.addInTaxAmount = addInTaxAmount;
    }
	...
	public ScmInvItemWrDetails() {
		super();
	}

	public ScmInvItemWrDetails(boolean flag) {
		super();
		if(flag) {
			...
			this.addInTaxAmount = BigDecimal.ZERO;
		}
	}
	@Override
