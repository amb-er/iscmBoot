...
public class ScmInvItemWrSumMaterialsDefaultValueBizImpl extends DefaultValueBizImpl{
	...
	public String getDefaultValue(String usrCode, String orgUnitNo, String controlUnitNo) {
		...
		defaultValue.append("invOrgUnitNo=").append(orgUnitNo).append(",").append("begDate=")
			.append(firstDay).append(",").append("endDate=").append(lastDay).append(",")
			.append("stockType=0").append(",noPost=N")
