...
public class ItemInAndOutSumDefaultValueBizImpl extends DefaultValueBizImpl{
	...
	public String getDefaultValue(String usrCode, String orgUnitNo, String controlUnitNo) {
		...
		defaultValue.append("invOrgUnitNo=").append(orgUnitNo).append(",").append("beginDate=")
			.append(firstDay).append(",").append("endDate=").append(lastDay).append(",").append("status=N").append(",")
