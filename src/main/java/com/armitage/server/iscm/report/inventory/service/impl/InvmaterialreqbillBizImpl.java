...
public class InvmaterialreqbillBizImpl  extends BaseReportDataBizImpl implements BaseReportDataBiz{
	...
	protected void afterGetReportData(Report2 report,
		...
		if (list != null && list.size() > 0) {
			for(int i=0;i<list.size();i++){
		        ...
		        if(StringUtils.isNotBlank((String)keyMap.get("useOrgUnitNo"))) {
		        	OrgBaseUnit2 orgBaseUnit = orgUnitBiz.selectbyOrgNo((String)keyMap.get("useOrgUnitNo"), param);
		        	if(orgBaseUnit!=null)
