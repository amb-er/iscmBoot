...
public class SupplierTransDefaultValueBizImpl extends DefaultValueBizImpl{
	...
	public String getDefaultValue(String usrCode, String orgUnitNo, String controlUnitNo) {
		...
		.append("minOrderDate=").append(firstDay).append(",reasonCode=0,")
		.append("maxOrderDate=").append(lastDay).append(",status=A,")
