...
public class PurHistoryPriceDefaultValueBizImpl extends DefaultValueBizImpl{
	...
	public String getDefaultValue(String usrCode, String orgUnitNo, String controlUnitNo) {
		...
		.append("minOrderDate=").append(firstDay).append(",")
		.append("maxOrderDate=").append(lastDay).append(",")
		.append("rowStatus=E").append(",")
