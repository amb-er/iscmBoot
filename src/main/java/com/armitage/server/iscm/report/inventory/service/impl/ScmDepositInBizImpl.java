...
public class ScmDepositInBizImpl extends BaseReportDataBizImpl implements BaseReportDataBiz{
	...
	protected void afterGetReportData(Report2 report,
	    ...
	    if (list != null && list.size() > 0) {
            for(int i=0;i<list.size();i++){
		        ...
		        if(keyMap.get("vendorId") != null && (Long)keyMap.get("vendorId")>0){
		        	scmsupplier = scmsupplierBiz.selectDirect((Long)keyMap.get("vendorId"), param);
		            if (scmsupplier != null)
