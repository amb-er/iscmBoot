...
public class ScmInvCountingTaskDefaultValueBizImpl extends DefaultValueBizImpl{
	...
	public String getDefaultValue(String usrCode, String orgUnitNo, String controlUnitNo) {
		...
		defaultValue.append("finOrgUnitNo=").append(orgUnitNo).append(",").append("beginDate=")
