...
@XmlRootElement(name = "scmPurMarketPriceEntry")  
public class ScmPurMarketPriceEntry extends BaseModel  {
	 
    public static final String FN_ID ="id";
    public static final String FN_PIID ="piId";
    ...
    public static final String FN_PREUSEQTY ="preUseQty";
	...
	public BigDecimal getPreUseQty() {
        return preUseQty;
    }

    public void setPreUseQty(BigDecimal val) {
        this.preUseQty = val;
    }
    ...
    public ScmPurMarketPriceEntry(boolean defaultValue){
       if(defaultValue){
    	   this.preUseQty=BigDecimal.ZERO;
    	   this.price=BigDecimal.ZERO;
       }
    }
  	public ScmPurMarketPriceEntry() {
