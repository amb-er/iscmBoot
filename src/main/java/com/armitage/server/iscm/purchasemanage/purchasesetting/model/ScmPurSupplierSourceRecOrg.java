...
@XmlRootElement(name = "scmPurSupplierSourceRecOrg")  
public class ScmPurSupplierSourceRecOrg extends BaseModel  {
    ...
    public ScmPurSupplierSourceRecOrg(boolean defaultValue){
       if(defaultValue){
       }
    }
  	public ScmPurSupplierSourceRecOrg() {
