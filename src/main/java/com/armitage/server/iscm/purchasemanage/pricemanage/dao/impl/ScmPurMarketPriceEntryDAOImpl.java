...
@Repository("scmPurMarketPriceEntryDAO")
public class ScmPurMarketPriceEntryDAOImpl extends BasicDAOImpl<ScmPurMarketPriceEntry> implements ScmPurMarketPriceEntryDAO {
	...
	public List<ScmPurMarketPriceEntry2> selectByPiId(HashMap<String, Object> map) throws DAOException {
		try {
			...
			return sqlSession.selectList(simpleName + ".selectByPiId",map);
		} catch (Exception e) {
			throw new DAOException("iscm.purchasemanage.pricemanage.dao.ScmPurMarketPriceEntryDAOImpl.error.selectByPiId", e);
		}
	}
