...
@XmlRootElement(name = "scmInvMoveInWarehsBillEntry")  
public class ScmInvMoveInWarehsBillEntry extends BaseModel {
	...
	public static final String FN_OUTBILLDTLID = "outBillDtlId";
	...
	public long getOutBillDtlId() {
		return outBillDtlId;
	}

	public void setOutBillDtlId(long val) {
		this.outBillDtlId = val;
	}
	...
	public ScmInvMoveInWarehsBillEntry(boolean defaultValue) {
		if (defaultValue) {
  	...
  	public ScmInvMoveInWarehsBillEntry() {
	}
