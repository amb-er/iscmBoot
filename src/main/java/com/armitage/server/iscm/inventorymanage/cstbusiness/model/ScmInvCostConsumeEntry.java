...
@XmlRootElement(name = "scmInvCostConsumeEntry")  
public class ScmInvCostConsumeEntry extends BaseModel  {
    ...
    public ScmInvCostConsumeEntry(boolean defaultValue){
       if(defaultValue){
