...
@XmlRootElement(name = "scmInvMoveIssueBillEntry")  
public class ScmInvMoveIssueBillEntry extends BaseModel  {
    ...
    public static final String FN_MOVEIN ="moveIn";
    ...
    public void setMoveIn(boolean val) {
        this.moveIn = val;
    }
    ...
    public ScmInvMoveIssueBillEntry(boolean defaultValue){
       if(defaultValue){
  	...
  	public ScmInvMoveIssueBillEntry() {
