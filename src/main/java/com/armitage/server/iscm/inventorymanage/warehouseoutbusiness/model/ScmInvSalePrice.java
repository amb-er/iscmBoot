...
@XmlRootElement(name = "scmInvSalePrice")  
public class ScmInvSalePrice extends BaseModel {
	...
	public ScmInvSalePrice(boolean defaultValue) {
		if (defaultValue) {
			this.currencyNo="";
	...
	public String[] getRequiredFields() {
		...
		*/
		return new String[] {FN_PMDATE,FN_BEGDATE,FN_ENDDATE};
	}
