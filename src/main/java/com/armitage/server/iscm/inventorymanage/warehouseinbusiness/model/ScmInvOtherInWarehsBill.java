...
@XmlRootElement(name = "scmInvOtherInWarehsBill")  
public class ScmInvOtherInWarehsBill extends BaseModel {
	...
	public ScmInvOtherInWarehsBill(boolean defaultValue) {
		if (defaultValue) {
			this.offset=false;
  	...
  	public ScmInvOtherInWarehsBill() {
	}
	...
	public String[] getRequiredFields() {
		return new String[] {FN_BIZTYPE,FN_BIZDATE,FN_WAREHOUSEID};
	}
