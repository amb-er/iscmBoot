...
@XmlRootElement(name = "scmInvOtherIssueBillEntry")  
public class ScmInvOtherIssueBillEntry extends BaseModel  {
	...
	public ScmInvOtherIssueBillEntry(boolean defaultValue){
    	if (defaultValue) {
  	...
  	public ScmInvOtherIssueBillEntry() {
