...
@XmlRootElement(name = "scmInvMoveIssueBill")  
public class ScmInvMoveIssueBill extends BaseModel  {
    ...
    public static final String FN_TOORGUNITNO ="toOrgUnitNo";
	...
	public String getToOrgUnitNo() {
        return toOrgUnitNo;
    }

    public void setToOrgUnitNo(String val) {
        this.toOrgUnitNo = val;
    }
    public boolean isOffset() {
        return offset;
    }

    public void setOffset(boolean val) {
        this.offset = val;
    }
	...
	public ScmInvMoveIssueBill(boolean defaultValue){
       if(defaultValue){
           this.offset=false;
	...
	public String[] getRequiredFields() {
		return new String[] {FN_BIZDATE,FN_WAREHOUSEID };
	}
