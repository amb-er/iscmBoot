...
public class ScmInvMaterialRequestBill extends BaseModel  {
    ...
    public void setRequestPerson(String val) {
        this.requestPerson = val;
    }
	...
	public ScmInvMaterialRequestBill(boolean defaultValue){
       if(defaultValue){
    	   this.currencyNo="";
  	...
  	public ScmInvMaterialRequestBill() {
	...
	public String[] getRequiredFields() {
		return new String[] {FN_BIZDATE,FN_ORGUNITNO,FN_INVORGUNITNO,FN_WAREHOUSEID };
	}
