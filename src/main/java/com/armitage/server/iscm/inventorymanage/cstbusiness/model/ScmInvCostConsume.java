...
@XmlRootElement(name = "scmInvCostConsume")  
public class ScmInvCostConsume extends BaseModel  {
	 
    public static final String FN_DCID ="dcId";
    public static final String FN_DCNO ="dcNo";
	...
	public static final String FN_GENERATE="generate";
	public static final String FN_SOURCETYPE="sourceType";
	public static final String FN_REFNO="refNo";
    ...
    public void setDcNo(String val) {
        this.dcNo = val;
    }
	...
	public ScmInvCostConsume(boolean defaultValue){
       if(defaultValue){
           this.currencyNo="";
	...
	public String[] getRequiredFields() {
        ...
        */
		return new String[] {FN_USEORGUNITNO,FN_BIZDATE};
	}
