...
@XmlRootElement(name = "scmCstInitBillEntry")  
public class ScmCstInitBillEntry extends BaseModel  {
    ...
    public ScmCstInitBillEntry(boolean defaultValue){
       if(defaultValue){
