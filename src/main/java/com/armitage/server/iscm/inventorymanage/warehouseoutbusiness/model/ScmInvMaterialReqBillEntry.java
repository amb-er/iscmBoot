...
@XmlRootElement(name = "scmInvMaterialReqBillEntry")  
public class ScmInvMaterialReqBillEntry extends BaseModel {
	...
	public ScmInvMaterialReqBillEntry(boolean defaultValue) {
		if (defaultValue) {
  	...
  	public ScmInvMaterialReqBillEntry() {
	}
