...
@XmlRootElement(name = "scmInvCountingTable")  
public class ScmInvCountingTable extends BaseModel {
	...
	public ScmInvCountingTable(boolean defaultValue) {
		if (defaultValue) {
		}
	}
  	public ScmInvCountingTable() {
	}
