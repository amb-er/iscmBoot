...
@XmlRootElement(name = "scmCstInitBill")  
public class ScmCstInitBill extends BaseModel  {
    ...
    public ScmCstInitBill(boolean defaultValue){
       if(defaultValue){
           this.currencyNo="";
    ...
    public String[] getRequiredFields() {
        ...
        */
        return new String[] {FN_BIZDATE, FN_ORGUNITNO};
    }
