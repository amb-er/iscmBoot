...
@XmlRootElement(name = "scmInvOtherIssueBill")  
public class ScmInvOtherIssueBill extends BaseModel  {
	...
	public ScmInvOtherIssueBill(boolean defaultValue){
       if(defaultValue){
    	   	this.offset=false;
	...
	public String[] getRequiredFields() {
		return new String[] {FN_BIZDATE,FN_BIZTYPE };
	}
