...
@XmlRootElement(name = "scmInvSaleOrder")  
public class ScmInvSaleOrder extends BaseModel  {
    ...
    public static final String FN_BARGAINED ="bargained";
	...
	public void setBargained(boolean bargained) {
	...
	public ScmInvSaleOrder(boolean defaultValue){
       if(defaultValue){
           this.currencyNo="";
	...
	public String[] getRequiredFields() {
		return new String[] {FN_CUSTID,FN_BIZDATE,FN_REQDATE };
	}
