...
public class ScmQualificationInfoPushJob implements Job{
	//private final static int excuteTimes = 9;
    private static Log log = LogFactory.getLog(ScmQualificationInfoPushJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            qualificationInfoPush(arg0.getJobDetail().getKey().getName());
    ...
    public void qualificationInfoPush(String jobName){
