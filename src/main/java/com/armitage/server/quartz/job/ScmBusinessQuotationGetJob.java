...
public class ScmBusinessQuotationGetJob implements Job{
	//private final static int excuteTimes = 9;
    private static Log log = LogFactory.getLog(ScmBusinessQuotationGetJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            businessQuotationGet(arg0.getJobDetail().getKey().getName());
    ...
    public void businessQuotationGet(String jobName){
