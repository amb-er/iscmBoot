...
public class ScmSupplierInfoPullJob implements Job{
	//private final static int excuteTimes = 9;
    private static Log log = LogFactory.getLog(ScmSupplierInfoPullJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            //supplierInfoPull(arg0.getJobDetail().getKey().getName());
    ...
    public void supplierInfoPull(String jobName){
