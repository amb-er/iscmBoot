...
public class ScmSupplierConfirmDataGetJob implements Job{
    private static Log log = LogFactory.getLog(ScmSupplierConfirmDataGetJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            getSupplierConfirmData(arg0.getJobDetail().getKey().getName());
    ...
    public void getSupplierConfirmData(String jobName){
