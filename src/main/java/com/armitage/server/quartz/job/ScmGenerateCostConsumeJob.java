...
public class ScmGenerateCostConsumeJob implements Job{
    private static Log log = LogFactory.getLog(ScmGenerateCostConsumeJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            generateCostConsume(arg0.getJobDetail().getKey().getName());
    ...
    public void generateCostConsume(String jobName){
