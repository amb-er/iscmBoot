...
public class ScmPurPricePushJob implements Job{
	//private final static int excuteTimes = 9;
    private static Log log = LogFactory.getLog(ScmPurPricePushJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            purPricePush(arg0.getJobDetail().getKey().getName());
    ...
    public void purPricePush(String jobName){
