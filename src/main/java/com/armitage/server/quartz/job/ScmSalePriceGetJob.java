...
public class ScmSalePriceGetJob implements Job{
    private static Log log = LogFactory.getLog(ScmSalePriceGetJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            getFbmSalePrice(arg0.getJobDetail().getKey().getName());
    ...
    public void getFbmSalePrice(String jobName){
