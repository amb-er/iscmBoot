...
public class ScmSupplierConfirmRulePushJob implements Job{
    private static Log log = LogFactory.getLog(ScmSupplierConfirmRulePushJob.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            confirmRulePush(arg0.getJobDetail().getKey().getName());
    ...
    public void confirmRulePush(String jobName){
