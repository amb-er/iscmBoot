...
public class ScmControlUnitPushJob implements Job{
    private static Log log = LogFactory.getLog(ScmControlUnitPushJob.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            controlUnitPush(arg0.getJobDetail().getKey().getName());
    ...
    public void controlUnitPush(String jobName){
