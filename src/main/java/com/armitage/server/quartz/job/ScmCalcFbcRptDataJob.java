...
public class ScmCalcFbcRptDataJob implements Job{
    private static Log log = LogFactory.getLog(ScmCalcFbcRptDataJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            calcFbcRptData(arg0.getJobDetail().getKey().getName());
    ...
    public void calcFbcRptData(String jobName){
