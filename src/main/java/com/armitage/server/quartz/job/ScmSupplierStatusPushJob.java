...
public class ScmSupplierStatusPushJob implements Job{

    private static Log log = LogFactory.getLog(ScmSupplierStatusPushJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            supplierStatusPush(arg0.getJobDetail().getKey().getName());
    ...
    public void supplierStatusPush(String jobName){
