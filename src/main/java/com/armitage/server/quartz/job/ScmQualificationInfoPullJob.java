...
public class ScmQualificationInfoPullJob implements Job{
	//private final static int excuteTimes = 9;
    private static Log log = LogFactory.getLog(ScmQualificationInfoPullJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            qualificationInfoPull(arg0.getJobDetail().getKey().getName());
    ...
    public void qualificationInfoPull(String jobName){
