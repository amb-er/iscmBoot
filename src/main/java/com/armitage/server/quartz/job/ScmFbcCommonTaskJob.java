...
public class ScmFbcCommonTaskJob implements Job{
    private static Log log = LogFactory.getLog(ScmFbcCommonTaskJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            fbcComTaskScan(arg0.getJobDetail().getKey().getName());
    ...
    public void fbcComTaskScan(String jobName){
