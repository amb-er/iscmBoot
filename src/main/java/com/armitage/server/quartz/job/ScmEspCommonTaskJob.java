...
public class ScmEspCommonTaskJob implements Job{
    private static Log log = LogFactory.getLog(ScmEspCommonTaskJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            eSPComTaskScan(arg0.getJobDetail().getKey().getName());
    ...
    public void eSPComTaskScan(String jobName){
