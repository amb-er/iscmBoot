...
@XmlRootElement(name = "scmCostCardDetail")  
public class ScmCostCardDetail extends BaseModel {
	...
	public ScmCostCardDetail(boolean defaultValue) {
		if (defaultValue) {
			this.type="01";
	...
	public Map<String, Integer> getDataLengthMap() {
		...
		map.put(FN_TYPE, 48);
		map.put(FN_ITEMNO, 48);
		map.put(FN_ITEMNAME, 240);
