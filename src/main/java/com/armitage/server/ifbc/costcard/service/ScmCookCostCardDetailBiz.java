...
public interface ScmCookCostCardDetailBiz extends BaseBiz<ScmCookCostCardDetail2> {
	/**
	 * 根据cardId查询
	 * @param cardId
	 * @param param
	...
	public List<ScmCookCostCardDetail2> checkItemCostPrice(ScmPriceUpdSet scmPriceUpdSet, Param param) throws AppException;
}
