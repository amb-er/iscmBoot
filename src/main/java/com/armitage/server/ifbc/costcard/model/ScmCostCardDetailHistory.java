...
@XmlRootElement(name = "scmCostCardDetailHistory")  
public class ScmCostCardDetailHistory extends BaseModel  {
    ...
    public ScmCostCardDetailHistory(boolean defaultValue){
       if(defaultValue){
       }
    }
  	public ScmCostCardDetailHistory() {
