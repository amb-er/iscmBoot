...
@XmlRootElement(name = "scmItemCostPrice")  
public class ScmItemCostPrice extends BaseModel  {
    ...
    public ScmItemCostPrice(boolean defaultValue){
       if(defaultValue){
       }
    }
  	public ScmItemCostPrice() {
