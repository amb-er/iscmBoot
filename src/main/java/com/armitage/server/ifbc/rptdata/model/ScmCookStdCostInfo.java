...
@XmlRootElement(name = "scmCookStdCostInfo")  
public class ScmCookStdCostInfo extends BaseModel  {
    ...
    public ScmCookStdCostInfo(boolean defaultValue){
       if(defaultValue){
       }
    }
  	public ScmCookStdCostInfo() {
