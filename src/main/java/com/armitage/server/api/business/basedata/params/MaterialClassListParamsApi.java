...
@ApiModel(value="MaterialClassListParamsApi")
public class MaterialClassListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private MaterialClassListParams params;
	...
	public MaterialClassListParams getParams() {
		return params;
	}
	public void setParams(MaterialClassListParams params) {
		this.params = params;
	}
}
