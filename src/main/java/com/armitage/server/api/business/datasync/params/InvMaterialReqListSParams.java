...
@ApiModel(value="InvMaterialReqListSParams",description="领料出库单对象")
public class InvMaterialReqListSParams {
	
	@JsonDeserialize(using = StringDeserializer.class)
	@ApiModelProperty(value="领料出库单号",dataType="String",example="MT20200606001",required=true)
	private String otNo;
	
	@JsonDeserialize(using = StringDeserializer.class)
	@ApiModelProperty(value="领料部门",dataType="String",example="00002125",required=true)
	...
	@ApiModelProperty(value="领料出库单明细",dataType="List",required=true)
	private List<InvMaterialReqDetailSParams> detailList;
	...
	public List<InvMaterialReqDetailSParams> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<InvMaterialReqDetailSParams> detailList) {
