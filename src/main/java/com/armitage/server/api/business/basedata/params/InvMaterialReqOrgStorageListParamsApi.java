...
@ApiModel(value="InvMaterialReqOrgStorageListParamsApi")
public class InvMaterialReqOrgStorageListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private InvMaterialReqOrgStorageListParams params;
	...
	public InvMaterialReqOrgStorageListParams getParams() {
		return params;
	}
	public void setParams(InvMaterialReqOrgStorageListParams params) {
		this.params = params;
	}
}
