...
@ApiModel(value="InvMaterialReqOrgAdminListParamsApi")
public class InvMaterialReqOrgAdminListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private InvMaterialReqOrgAdminListParams params;
	...
	public InvMaterialReqOrgAdminListParams getParams() {
		return params;
	}
	public void setParams(InvMaterialReqOrgAdminListParams params) {
		this.params = params;
	}
}
