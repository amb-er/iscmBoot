...
@ApiModel(value="OrgAdminListParamsApi")
public class OrgAdminListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private OrgAdminListParams params;
	...
	public OrgAdminListParams getParams() {
		return params;
	}
	public void setParams(OrgAdminListParams params) {
		this.params = params;
	}
}
