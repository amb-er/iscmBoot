...
@ApiModel(value="InvMaterialReqAddParams",description="新增参数对象")
public class InvMaterialReqAddParams {
	...
	@ApiModelProperty(value="单据明细",dataType="List<PurRequireDetailParams>",example="",required=false)
