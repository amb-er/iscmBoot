...
@ApiModel(value="PurOrderListResult",description="返回结果集resultList")
public class PurOrderListResult {
	...
	@ApiModelProperty(value="订货金额",dataType="BigDecimal")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	private BigDecimal amt;

	@ApiModelProperty(value="订货含税金额",dataType="BigDecimal")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
