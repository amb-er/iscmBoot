...
@ApiModel(value="PurReceiveListParamsApi")
public class PurReceiveListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private PurReceiveListParams params;
	...
	public PurReceiveListParams getParams() {
		return params;
	}
	public void setParams(PurReceiveListParams params) {
		this.params = params;
	}
}
