...
@ApiModel(value="PurRequireEditParams",description="修改参数对象")
public class PurRequireEditParams {
	@ApiModelProperty(value="请购单号",dataType="String",example="123",required=true)
	private String prNo;
	
	@ApiModelProperty(value="申购组织",dataType="String",example="00001",required=true)
	private String reqOrgUnitNo;
	
	@ApiModelProperty(value="申购人",dataType="String",example="123",required=false)
	private String applicants;
	
	@ApiModelProperty(value="申购日期",dataType="Date",example="2019-05-22 00:00:00",required=true)
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone="GMT+8")
	private Date applyDate;
	
	@ApiModelProperty(value="需求日期",dataType="Date",example="2019-05-22 00:00:00",required=true)
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone="GMT+8")
	...
	@ApiModelProperty(value="仓库收货",dataType="Boolean",example="0",required=true)
	private boolean toWareHouse;

	@ApiModelProperty(value="收货仓库编号",dataType="String",example="001",required=false)
