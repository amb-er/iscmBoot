...
@ApiModel(value="MaterialDetailedParamsApi")
public class MaterialDetailedParamsApi extends RequestParams {
	...
	@ApiModelProperty(required = true)
	private MaterialDetailedParams params;
	...
	public MaterialDetailedParams getParams() {
		return params;
	}
	public void setParams(MaterialDetailedParams params) {
		this.params = params;
	}
