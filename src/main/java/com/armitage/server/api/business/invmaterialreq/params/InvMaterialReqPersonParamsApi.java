...
@ApiModel(value="InvMaterialReqPersonParamsApi")
public class InvMaterialReqPersonParamsApi extends RequestParams {
	...
	@ApiModelProperty(required = true)
	private InvMaterialReqPersonParams params;
	...
	public InvMaterialReqPersonParams getParams() {
		return params;
	}
	public void setParams(InvMaterialReqPersonParams params) {
		this.params = params;
	}
}
