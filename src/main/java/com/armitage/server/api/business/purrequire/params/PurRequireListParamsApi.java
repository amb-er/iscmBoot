...
@ApiModel(value="PurRequireListParamsApi")
public class PurRequireListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private PurRequireListParams params;
	...
	public PurRequireListParams getParams() {
		return params;
	}
	public void setParams(PurRequireListParams params) {
		this.params = params;
	}
}
