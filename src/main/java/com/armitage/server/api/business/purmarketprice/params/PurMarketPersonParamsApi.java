...
@ApiModel(value="PurMarketPersonParamsApi")
public class PurMarketPersonParamsApi extends RequestParams {
    @ApiModelProperty(required = true)
    public ApiLogicSymbol logicSymbol;
    @ApiModelProperty(required = true)
    public PageNum pageNum;
	@ApiModelProperty(required = true)
	private PurMarketPersonParams params;
	...
	public PurMarketPersonParams getParams() {
		return params;
	}

	public void setParams(PurMarketPersonParams params) {
		this.params = params;
	}	
}
