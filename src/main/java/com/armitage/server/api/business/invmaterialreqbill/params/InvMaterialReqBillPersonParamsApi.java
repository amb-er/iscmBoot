...
@ApiModel(value="InvMaterialReqBillPersonParamsApi")
public class InvMaterialReqBillPersonParamsApi extends RequestParams{
	...
	@ApiModelProperty(required = true)
	private InvMaterialReqBillPersonParams params;
	...
	public InvMaterialReqBillPersonParams getParams() {
		return params;
	}

	public void setParams(InvMaterialReqBillPersonParams params) {
		this.params = params;
	}
}
