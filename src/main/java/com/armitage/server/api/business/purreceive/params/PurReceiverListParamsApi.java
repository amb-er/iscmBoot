...
@ApiModel(value="PurReceiverListParamsApi")
public class PurReceiverListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private PurReceiverListParams params;
	...
	public PurReceiverListParams getParams() {
		return params;
	}
	public void setParams(PurReceiverListParams params) {
		this.params = params;
	}
}
