...
@ApiModel(value="CountCostMaterialListParamsApi")
public class CountCostMaterialListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private CountCostMaterialListParams params;
	...
	public CountCostMaterialListParams getParams() {
		return params;
	}
	public void setParams(CountCostMaterialListParams params) {
		this.params = params;
	}
}
