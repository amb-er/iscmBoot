...
@ApiModel(value="InvOtherIssueResult",description="返回结果集resultList")
public class InvOtherIssueResult {
	...
	@ApiModelProperty(value="出库仓库",dataType="String")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	...
	@ApiModelProperty(value="是否冲销",dataType="Boolean")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	...
	private List<InvOtherIssueDetailResult> detailList;
	...
	public List<InvOtherIssueDetailResult> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<InvOtherIssueDetailResult> detailList) {
