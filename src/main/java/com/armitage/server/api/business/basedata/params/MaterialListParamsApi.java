...
@ApiModel(value="MaterialListParamsApi")
public class MaterialListParamsApi extends RequestParams {
	@ApiModelProperty(required = true)
	public ApiLogicSymbol logicSymbol;
	@ApiModelProperty(required = true)
	public PageNum pageNum;
	@ApiModelProperty(required = true)
	private MaterialListParams params;
	...
	public MaterialListParams getParams() {
		return params;
	}
	public void setParams(MaterialListParams params) {
		this.params = params;
	}
}
