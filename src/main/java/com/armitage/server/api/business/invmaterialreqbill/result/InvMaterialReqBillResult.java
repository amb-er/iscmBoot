...
@ApiModel(value="InvMaterialReqBillResult",description="返回结果集resultList")
public class InvMaterialReqBillResult {
	...
	@ApiModelProperty(value="领料部门",dataType="String")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	...
	private List<InvMaterialReqBillDetailResult> detailList;
	...
	public List<InvMaterialReqBillDetailResult> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<InvMaterialReqBillDetailResult> detailList) {
