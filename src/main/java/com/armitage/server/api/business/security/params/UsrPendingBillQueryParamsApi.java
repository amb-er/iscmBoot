...
@ApiModel(value="UsrPendingBillQueryParamsApi")
public class UsrPendingBillQueryParamsApi extends RequestParams {
	...
	@ApiModelProperty(required = true)
	private UsrPendingBillQueryParams params;
	...
	public UsrPendingBillQueryParams getParams() {
		return params;
	}

	public void setParams(UsrPendingBillQueryParams params) {
		this.params = params;
	}
