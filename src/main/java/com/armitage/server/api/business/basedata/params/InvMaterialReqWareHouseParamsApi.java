...
@ApiModel(value="InvMaterialReqWareHouseParamsApi")
public class InvMaterialReqWareHouseParamsApi extends RequestParams {
    @ApiModelProperty(required = true)
    public ApiLogicSymbol logicSymbol;
    @ApiModelProperty(required = true)
    public PageNum pageNum;
	@ApiModelProperty(required = true)
	private InvMaterialReqWareHouseParams params;
	...
	public InvMaterialReqWareHouseParams getParams() {
		return params;
	}

	public void setParams(InvMaterialReqWareHouseParams params) {
		this.params = params;
	}	
}
