...
@ApiModel(value="InvMaterialReqBillListParamsApi")
public class InvMaterialReqBillListParamsApi extends RequestParams{
	...
	@ApiModelProperty(required = true)
	private InvMaterialReqBillListParams params;
	...
	public InvMaterialReqBillListParams getParams() {
		return params;
	}

	public void setParams(InvMaterialReqBillListParams params) {
		this.params = params;
	}
