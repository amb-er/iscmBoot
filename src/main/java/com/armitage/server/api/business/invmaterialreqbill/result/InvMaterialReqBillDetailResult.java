...
@ApiModel(value="InvMaterialReqBillDetailResult",description="返回结果集resultList")
public class InvMaterialReqBillDetailResult {
	...
	@ApiModelProperty(value="出库数量",dataType="BigDecimal")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	...
	@ApiModelProperty(value="需求数量",dataType="BigDecimal")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
