...
@ApiModel(value="PurOrderResult",description="返回结果集resultList")
public class PurOrderResult {
	...
	@ApiModelProperty(value="集中结算",dataType="Boolean")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	private boolean centeralBalance;

	@ApiModelProperty(value="统一配送",dataType="Boolean")
	@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
	...
	private List<PurOrderDetailResult> detailList;
	...
	public List<PurOrderDetailResult> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<PurOrderDetailResult> detailList) {
